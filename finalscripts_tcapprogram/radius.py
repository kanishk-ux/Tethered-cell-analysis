...
#x = [36, 36, 19, 18, 33, 26]a
#y = [14, 10, 28, 31, 18, 26]
# coordinates of the barycenter
limit = max(utilities.num_frames,500)
radius2 = []
residues12 = []
residues22 = []
...
print('method 2b starts')
print(Ri_2b)
print(R_2b)
print(residu_2b)
print(residu2_2b)
print('method 2b ends')
"""
...
print('method 3b starts')
print(Ri_3b)
print(R_3b)
print(residu_3b)
print(residu2_3b)
print('method 3b ends')
...
#print ('%-22s' +' %10s'*7) % tuple('METHOD Xc Yc Rc nb_calls std(Ri) residu residu2'.split())
# print '-'*(22 +7*(10+1))
